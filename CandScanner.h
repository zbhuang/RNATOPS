...
public:
    ...
    Candid * scanTopnInTwoRegion( Stem *pstem,  CYKSearch & curcyk, double coeff);
    //speedup
...
public:
    ...
    void printCandids( char type='B', int displayfmt=1 ); //B: stem and loop;   S: stem;   L:loop
                                                          //0: align part   1:all
    int searchCandids( Stem *pstem, int numsm, int topn, double thres, char * pStr );
