...
public:
    ...
    int getLeftArmlen( double coeff=COESTDEV, int ismax=0 );
    int getRightArmlen( double coeff=COESTDEV, int ismax=0 );
    int getLeftOffset( double coeff=COESTDEV, int ismax=0, int thd=0 );
    int getRightOffset( double coeff=COESTDEV, int ismax=0, int thd=0 );
    //for the case of sum of component's E and SD
    int getLeftArmRegion( double coeff, int region[2], int thd=0 );
    int getRightArmRegion( double coeff, int region[2], int thd=0 );
